    ...
    */
    ...
    public function up()
    {
        ...
        $init_config = array(
            ...
            array(1, 'error-email-404', 'Send 404 Errors', 6, 0),
            array(1, 'error-email-405', 'Send 405 Errors', 6, 0),
            array(1, 'error-email-500', 'Send 500 Errors', 6, 1),
            ...
            array(4, 'home-paragraph-color', 'Home Paragraph Color', 8, '#D4F8FD'),
        );
