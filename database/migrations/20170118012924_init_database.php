    ...
    */
    ...
    public function up()
    {
        ...
        $init_config_groups = array(
            ...
            array(4, "Contact Information", null, null),
            array(5, "Error Monitoring", null, null),
        );
        ...
        $init_config = array(
            ...
            array(5, 'error-email', 'Email Errors To', 2, ''),
            array(5, 'error-email-404', 'Send 404 Errors', 6, 0),
            array(5, 'error-email-405', 'Send 405 Errors', 6, 0),
            array(5, 'error-email-500', 'Send 500 Errors', 6, 1),
            array(4, 'contact-email', 'Contact Email', 2, 'contact@example.com'),
            array(4, 'contact-phone', 'Contact Phone', 2, '(000) 000-0000'),
            array(4, 'contact-street', 'Contact Street', 2, '123 Harbor Blvd.'),
            array(4, 'contact-city', 'Contact City', 2, 'Oxnard'),
            array(4, 'contact-state', 'Contact State', 2, 'CA'),
            array(4, 'contact-zip', 'Contact Zip', 2, '93035'),
