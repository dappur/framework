...
class Settings extends Controller
{
	public function settingsGlobal(Request $request, Response $response){
        ...
        return $this->view->render($response, 'Admin/settings-global.twig', array("globalConfig" => $global_config, "themeList" => $theme_list, "timezones" => $timezones));
    ...
    public function settingsDeveloper(Request $request, Response $response){
        ...
        */
    	...
    	return $this->view->render($response, 'Admin/settings-developer.twig', array("settingsFile" => $settings_file, "postVars" => $allPostVars));
    }
