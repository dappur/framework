        ...
        if($request->getParam('code') || $request->getParam('oauth_token')) {
          	...
          	switch ($provider->slug) {
          		...
          		case 'twitter':
          			...
          			$tw_array = array();
          			try {
          				$access_token = $tw_connection->oauth("oauth/access_token", ["oauth_token" => $request->getParam('oauth_token'), "oauth_verifier" => $request->getParam('oauth_verifier')]);
                    	...
                    	$tw_array['expires_in'] = $access_token['x_auth_expires'];
          				...
          				$tw_array['error'] = (object) array("message" => (string) "An error occured.  Please try again.");
          			}
